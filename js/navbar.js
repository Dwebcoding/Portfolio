...
function loadNavbar() {
  // Determina il percorso del logo in modo dinamico
  const logoPath = window.location.pathname.includes('/html/')
    ? '/Portfolio/Assets/Images/Portfolio/Logo%20BIG%202.png'
    : 'Assets/Images/Portfolio/Logo%20BIG%202.png';
    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container">
            <a class="navbar-brand" href="/index.html">
                <img src="${logoPath}" alt="D Webcoding Logo" height="60">
            </a>
